            ...
            <head>
                ...
                // Call check on page load
                                ...
                                <div class="row h-100">
                                    ...
                                    <div
                                        ...
                                        <ul class="nav nav-pills nav-justified flex-column w-100 pt-4">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link sidebar-nav mt-1 active" href="logout.xml" id="logout-nav">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-1" height="24px" viewBox="0 -960 960 960" width="24px"
                                                         fill="#FFFFFF">
                                                        <path
                        ...
                        <div class="main-container h-100 d-inline-flex justify-content-center gap-3 align-items-center" style="flex: 1;">
                            <div class="p-5 text-center" style="max-width: 500px; margin-left: 130px;">
                                <div class="mb-3">
                                    <br/><br/><br/><br/><br/>
                                ...
                                <div class="d-flex justify-content-center gap-2 mt-4">
                                    <button type="button" class="btn-red"
                                            onclick="window.location.href='caretaker-dashboard.xml'">Cancel</button>
