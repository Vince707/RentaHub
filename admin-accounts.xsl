        ...
        <html lang="en">
            <head>
                ...
                document.addEventListener('DOMContentLoaded', checkUserAccess);
                            ...
                            $('#accounts-information-table').DataTable({
                            layout: {
                            bottomStart: {
                    ...
                    <p>Loading, please wait...</p>
                            ...
                            <div class="container-fluid h-100">
                                ...
                                <li class="nav-item" id="accounts-menu-item" style="display: none;">
                                    <a class="nav-link sidebar-nav mt-1 active" href="admin-accounts.xml">
                                    ...
                                    <div class="main-container h-100 p-4" id="main-container">
                                        <div class="d-flex flex-sm-row flex-column justify-content-between align-items-start">
                                            <p class="h2 font-red-gradient">Add Account</p>
                                            <div class="d-flex flex-row align-items-center">
                                                <button type="button" class="ms-1 btn-red d-flex align-items-center px-3 py-1" id="account-button-add-account" data-bs-toggle="modal" data-bs-target="#modalAddAccount">
                                        ...
                                        <div class="row gx-3 gy-3">
                                            <div class="col-12 col-sm-6 col-lg-3">
                                                <div class="gradient-red-bg d-flex flex-column align-items-center justify-content-center rounded-4 p-3 px-4 h-100">
                                                    <p class="h5 font-white my-0 text-center">Number of Accounts</p>
                                                    <p class="h1 font-white my-0" id="total-accounts">0</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-3">
                                                <div class="red-border d-flex flex-column align-items-center justify-content-center rounded-4 p-3 px-4 h-100">
                                                    <p class="h5 font-red my-0">Inactive Accounts</p>
                                                    <p class="h1 font-red my-0" id="total-inactive-accounts">0</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-3">
                                                <div class="red-border d-flex flex-column align-items-center justify-content-center rounded-4 p-3 px-4 h-100">
                                                    <p class="h5 font-red my-0">Caretaker Accounts</p>
                                                    <p class="h1 font-red my-0" id="total-caretaker-accounts">0</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-3">
                                                <div class="red-border d-flex flex-column align-items-center justify-content-center rounded-4 p-3 px-4 h-100">
                                                    <p class="h5 font-red my-0">Renter Accounts</p>
                                                    <p class="h1 font-red my-0" id="total-renter-accounts">0</p>
                                                </div>
                                            </div>
                                                        
                                        </div>
                            
                            <table class="custom-table mt-3" id="accounts-information-table">
                                <thead>
                                    <tr>
                                        <th>Account ID</th>
                                        <th>Email Address</th>
                                ...
                                <tbody>
                                    <xsl:for-each select="$data//users/user">
                                        <tr>
                                            <td>
                                                <!-- Assuming @id attribute holds account ID -->
                                            ...
                                            <td>
                                                ...
                                                <xsl:value-of select="concat(substring(dateGenerated,6,2), '/', substring(dateGenerated,9,2), '/', substring(dateGenerated,1,4))"/>
                                            </td>
                                            <td>
                                                ...
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <span class="badge rounded-pill">
                                                        <xsl:choose>
                                                            ...
                                                            <xsl:when test="status = 'Archived'">
                                                                <xsl:attribute name="class">badge rounded-pill bg-secondary</xsl:attribute>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                    <div class="modal-content p-4">
                                        ...
                                        <div class="modal-header">
                                            <p class="modal-title h2 font-red-gradient">Add Account</p>
                                        </div>
                                            ...
                                            <div class="d-flex flex-row mb-3 flex-wrap">
                                                <div class="form-floating me-2 flex-fill">
                                                    <input type="text" class="form-control" id="add-account-email-address" placeholder="" required="required"/>
                                                        <label for="add-account-email-address">Email Address *</label>
                                                    </div>
                                                    <div class="form-floating position-relative me-2 flex-fill">
                                                        <input type="password" class="form-control" id="add-account-password" placeholder="Password" required="required"/>
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    onclick="togglePasswordVisibility('add-account-password')">
                                                                <i id="eyeIcon" class="bi bi-eye-slash"></i>
                                                            </button>
                                                        </div>
                                                        <div class="me-2 mb-3 flex-fill">
                                                            <select class="form-select custom-select" id="add-account-account-role" required="required" style="height: 3.5rem;">
                                                                <option selected="selected" disabled="disabled " hidden="hidden">Account Role *</option>
                                                ...
                                                <div class="modal-footer d-flex justify-content-between">
                                                    <div id="error-box-add-account"
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="small" id="error-text-add-account"></span>
                                                        </div>
                                                    </div>
                                                    <div class="ms-auto">
                                                        <button type="button" class="btn-red" data-bs-dismiss="modal" id="button-cancel-add-account">Cancel</button>
                                                        <button type="button" class="btn-green-fill" id="button-add-account">Add</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Modal Add Account Confirmation -->
                                    <div class="modal fade" id="modalAddAccountConfirmation" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-lg modal-fullscreen-md-down">
                                            <div class="modal-content p-4">
                                                
                                                <!-- Modal Header -->
                                                <div class="modal-header justify-content-center">
                                                    <p class="modal-title h2 font-red-gradient text-center w-100">Add Account Confirmation</p>
                                                </div>
                                    ...
                                    <!-- Modal Add Account Success -->
                                    <div class="modal fade" id="modalAddAccountSuccess" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-md modal-fullscreen-md-down">
                                            <div class="modal-content p-4">
                                                
                                                <!-- Modal Header -->
                                                <div class="modal-header d-flex align-items-center justify-content-center">
                                                    <p class="modal-title h2 font-green text-center">Add Account Success!</p>
                                                </div>
                                                ...
                                                <div class="modal-footer d-flex align-items-center justify-content-center">
                                                    <button type="button" class="btn-green-fill" data-bs-dismiss="modal" id="button-success-add-account">Confirm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="modalModifyAccount" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                            <div class="modal-content p-4">
                                                
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <p class="modal-title h2 font-red-gradient">Modify Account</p>
                                                </div>
                                                ...
                                                <div class="modal-body d-flex flex-column">
                                                    ...
                                                    <div class="d-flex flex-row mb-3 flex-wrap">
                                                        <!-- Email Address Field -->
                                                        <div class="form-floating me-2 flex-fill">
                                                            <input type="text" class="form-control" id="modify-account-email-address" placeholder="" required="required"/>
                                                                <label for="modify-account-email-address">Email Address *</label>
                                                            </div>
                                                            <!-- Password Field -->
                                                            <div class="form-floating position-relative me-2 flex-fill">
                                                                <input type="password" class="form-control" id="modify-account-password" placeholder="Password" required="required"/>
                                                                    <label for="modify-account-password">Password *</label>
                                                                    <button type="button"
                                                                            class="btn btn-sm position-absolute end-0 top-50 translate-middle-y me-3 border-0 bg-transparent"
                                                                            onclick="togglePasswordVisibility('modify-account-password')">
                                                                        <i id="eyeIcon" class="bi bi-eye-slash"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-row mb-3 flex-wrap">
                                                                ...
                                                                <div class="me-2 mb-3 flex-fill">
                                                                    <select class="form-select custom-select" id="modify-account-account-role" required="required" style="height: 3.5rem;">
                                                                        <option selected="selected" disabled="disabled " hidden="hidden">Account Role *</option>
                                                                        <option value="admin">Admin</option>
                                                                        <option value="caretaker">Caretaker</option>
                                                                        <option value="renter">Renter</option>
                                                                ...
                                                                <!-- Status Dropdown -->
                                                                <div class="me-2 mb-3 flex-fill">
                                                                    <select class="form-select custom-select" id="modify-account-status" required="required" style="height: 3.5rem;">
                                                                        <option selected="selected" disabled="disabled " hidden="hidden">Status *</option>
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer d-flex justify-content-between">
                                                            <div id="error-box-modify-account"
                                                                 class="alert d-none flex-row align-items-start gap-3 p-3 border-0 rounded-3 col-10 col-lg-6"
                                                                 style="color:white; background-color: #a6192e;">
                                                                <i class="bi bi-exclamation-triangle-fill fs-3"></i>
                                                                <div>
                                                            ...
                                                            <div class="ms-auto">
                                                                <button type="button" class="btn-red" data-bs-dismiss="modal"
                                                                        id="button-cancel-modify-account">Cancel</button>
                                                                <button type="button" class="btn-green-fill" id="button-modify-account">Modify</button>
                                                            </div>
                                                        </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Modal Modify Account Confirmation -->
                                    <div class="modal fade" id="modalModifyAccountConfirmation" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-lg modal-fullscreen-md-down">
                                            <div class="modal-content p-4">
                                                
                                                <!-- Modal Header -->
                                                <div class="modal-header justify-content-center">
                                                    <p class="modal-title h2 font-red-gradient text-center">Modify Account Confirmation</p>
                                                </div>
                                                ...
                                                <div class="modal-body d-flex justify-content-center text-center">
                                                    <div class="d-flex flex-column align-items-center">
                                                        ...
                                                        <div class="d-flex">
                                                            <p class="h5 font-red-gradient me-2 mb-1">Password:</p>
                                                            <p id="confirm-modify-account-password" class="font-red mb-1"></p>
                                                        </div>
                                                        <div class="d-flex">
                                                            <p class="h5 font-red-gradient me-2 mb-1">Account Role:</p>
                                                            <p id="confirm-modify-account-account-role" class="font-red mb-1"></p>
                                                        </div>
                                                        <div class="d-flex">
                                                            <p class="h5 font-red-gradient me-2 mb-1">Account Status:</p>
                                                            <p id="confirm-modify-account-account-status" class="font-red mb-1"></p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <!-- Modal Modify Account Success -->
                                    <div class="modal fade" id="modalModifyAccountSuccess" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-md modal-fullscreen-md-down">
                                            <div class="modal-content p-4">
                                                
                                                <!-- Modal Header -->
                                                <div class="modal-header d-flex align-items-center justify-content-center">
                                                    <p class="modal-title h2 font-green text-center">Modify Account Success!</p>
                                                </div>
                                                ...
                                                <div class="modal-footer d-flex align-items-center justify-content-center">
                                                    <button type="button" class="btn-green-fill" data-bs-dismiss="modal"
                                                            id="button-success-modify-account">Confirm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="modalDeleteAccountConfirmation" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-lg modal-fullscreen-md-down">
                                            <div class="modal-content p-4">
                                                
                                                <!-- Modal Header -->
                                                <div class="modal-header justify-content-center">
                                                    <p class="modal-title h3 font-red-gradient text-center">Delete Account Confirmation</p>
                                                </div>
                                                ...
                                                <div class="modal-body d-flex justify-content-center text-center">
                                                    <div class="d-flex flex-column align-items-center">
                                                        ...
                                                        <div class="d-flex">
                                                            <p class="h5 font-red-gradient me-2 mb-1">Username:</p>
                                                            <p id="confirm-delete-account-username" class="font-red mb-1"></p>
                                                        </div>
                                                        <div class="d-flex">
                                                            <p class="h5 font-red-gradient me-2 mb-1">Password:</p>
                                                            <p id="confirm-delete-account-password" class="font-red mb-1"></p>
                                                        </div>
                                                        <div class="d-flex">
                                                            <p class="h5 font-red-gradient me-2 mb-1">Account Role:</p>
                                                            <p id="confirm-delete-account-account-role" class="font-red mb-1"></p>
                                                        </div>
                                                        <div class="d-flex">
                                                            <p class="h5 font-red-gradient me-2 mb-1">Account Status:</p>
                                                            <p id="confirm-delete-account-account-status" class="font-red mb-1"></p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="modal fade" id="modalDeleteAccountSuccess" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered modal-md modal-fullscreen-md-down">
                                            <div class="modal-content p-4">
                                                
                                                <!-- Modal Header -->
                                                <div class="modal-header d-flex align-items-center justify-content-center">
                                                    <p class="modal-title h2 font-green text-center">Delete Account Success!</p>
                                                </div>
                                                ...
                                                <div class="modal-footer d-flex align-items-center justify-content-center">
                                                    <button type="button" class="btn-green-fill" data-bs-dismiss="modal"
                                                            id="button-success-delete-account">Confirm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
