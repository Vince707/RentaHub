    ...
    <div class="row h-100">
      ...
      <div
        ...
        <ul class="nav nav-pills nav-justified flex-column w-100 pt-4">
          ...
          <li class="nav-item">
            <a class="nav-link sidebar-nav mt-1" href="caretaker-renter.html" id="journal-nav">
              <svg xmlns="http://www.w3.org/2000/svg" class="me-1" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#FFFFFF">
                <path
          ...
          <li class="nav-item">
            <a class="nav-link sidebar-nav mt-1" href="caretaker-room.html" id="ledger-nav">
              <svg xmlns="http://www.w3.org/2000/svg" class="me-1" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#FFFFFF">
                <path
          ...
          <li class="nav-item">
            <a class="nav-link sidebar-nav mt-1" href="caretaker-billings.html" id="savings-nav">
              <svg xmlns="http://www.w3.org/2000/svg" class="me-1" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#FFFFFF">
                <path
          ...
          <li class="nav-item">
            <a class="nav-link sidebar-nav mt-1" href="caretaker-payments.html" id="budgeting-nav">
              <svg xmlns="http://www.w3.org/2000/svg" class="me-1" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#FFFFFF">
                <path
          ...
          <li class="nav-item">
            <a class="nav-link sidebar-nav mt-1 active" href="caretaker-help.html" id="help-nav">
              <svg xmlns="http://www.w3.org/2000/svg" class="me-1" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#FFFFFF">
                <path
          ...
          <li class="nav-item">
            <a class="nav-link sidebar-nav mt-1" href="logout.html" id="logout-nav">
              <svg xmlns="http://www.w3.org/2000/svg" class="me-1" height="24px" viewBox="0 -960 960 960" width="24px"
                fill="#FFFFFF">
                <path
        ...
        <div class="d-flex mt-auto align-items-center align-self-center flex-column">
          ...
          <p class="align-self-center pt-0 mt-0" style="font-size: 0.6rem">
            &copy; <span class="current-year"></span> RentaHub. All Rights
            Reserved.
          </p>
        </div>
      </div>
      ...
      <div class="accordion mt-4" id="accordionRenter">
        ...
        <div id="faqA1" class="accordion-collapse collapse" data-bs-parent="#accordionRenter">
          <div class="accordion-body">
            Go to the <span class="badge bg-danger"><i class="bi bi-person-lines-fill"></i> Renter Information</span> tab, click
            <button type="button" class="ms-1 btn-red d-inline-flex align-items-center gap-2 px-3 py-1" id="renter-button-modify-renter" data-bs-toggle="modal" data-bs-target="#modalAddRenter">
            <svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 -960 960 960" width="18px" fill="#8E1616"> <path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/> </svg>
        ...
        <div class="accordion-item">
          ...
          <div id="faqA2" class="accordion-collapse collapse" data-bs-parent="#accordionRenter">
            <div class="accordion-body">
              Yes. Navigate to <span class="badge bg-danger"><i class="bi bi-person-lines-fill"></i> Renter Information</span>, then click
              <button type="button" class="btn-red d-inline-flex align-baseline px-2 py-1" id="dashboard-button-edit-renter" style="font-size: 0.875rem; border-radius: 0.5rem; vertical-align: baseline;">
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#8E1616" class="me-1">
        ...
        <div class="accordion-item">
          ...
          <div id="faqA3" class="accordion-collapse collapse" data-bs-parent="#accordionRenter">
            <div class="accordion-body">
              Go to the <span class="badge bg-danger"><i class="bi bi-person-lines-fill"></i> Renter Information</span> tab, click
            <button type="button" class="btn-red d-inline-flex align-baseline px-2 py-1" id="dashboard-button-delete-renter" style="font-size: 0.875rem; border-radius: 0.5rem; vertical-align: baseline;">
            <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#8E1616" class="me-1">
            <path d="M261-120q-28 0-47.5-19.5T194-187v-46h572v46q0 28-19.5 47.5T699-120H261Zm-67-106v-60l43-414q2-17 14.5-28.5T280-740h122v-20q0-13 9-22.5t22-9.5h94q13 0 22.5 9.5T559-760v20h121q17 0 29.5 11.5T724-688l43 414v60H194Zm152-80h60V-620h-60v314Zm135 0h60V-620h-60v314Zm135 0h60V-620h-60v314Z"/>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingA4">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqA4">
          ...
          <div id="faqA4" class="accordion-collapse collapse" data-bs-parent="#accordionRenter">
            <div class="accordion-body">
              Use the search bar in the <span class="badge bg-danger"><i class="bi bi-person-lines-fill"></i> Renter Information</span> tab to filter by name, room number, or contact info.
          </div>
        </div>
      </div>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingA5">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqA5">
              <span class="text-start text-wrap w-100">How can I view a renter’s stay and payment history?</span>
            </button>
          </h2>
          <div id="faqA5" class="accordion-collapse collapse" data-bs-parent="#accordionRenter">
            <div class="accordion-body">
              Navigate to <span class="badge bg-danger"><i class="bi bi-person-lines-fill"></i> Renter Information</span>, then search the renter’s name. Their profile will display room assignments, move-in/move-out dates, and past billing transactions.
          </div>
        </div>
      </div>
        ...
        <div class="accordion-item">
          ...
          <div id="faqB1" class="accordion-collapse collapse" data-bs-parent="#accordionBilling">
            <div class="accordion-body">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#8B0000"><path d="M280-280h80v-200h-80v200Zm320 0h80v-400h-80v400Zm-160 0h80v-120h-80v120Zm0-200h80v-80h-80v80ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm0-560v560-560Z"/></svg>
              Generate Report
        ...
        <div class="accordion-item">
          ...
          <div id="faqB2" class="accordion-collapse collapse" data-bs-parent="#accordionBilling">
            <div class="accordion-body">
              Yes, go to <span class="badge bg-danger"><i class="bi bi-cash-coin"></i> Payments</span> tab to view all transactions.
          </div>
        </div>
      </div>
        ...
        <div class="accordion-item">
          ...
          <div id="faqB3" class="accordion-collapse collapse" data-bs-parent="#accordionBilling">
            <div class="accordion-body">
              Navigate to the <span class="badge bg-danger"><i class="bi bi-cash"></i> Payments</span> tab, click <span class="badge rounded-pill bg-success ms-1">Paid</span> to mark as full payment.
          </div>
        </div>
      </div>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingB4">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqB4">
              <span class="text-start text-wrap w-100">How do I check the current electric bill for a renter?</span>
            </button>
          </h2>
          <div id="faqB4" class="accordion-collapse collapse" data-bs-parent="#accordionBilling">
            <div class="accordion-body">
              Go to the <span class="badge bg-danger"><i class="bi bi-receipt"></i> Billing</span> tab, click 
              <button type="button" class=" ms-1 btn-red d-inline-flex align-items-center gap-2 px-3 py-1" id="renter-button-archives" data-bs-toggle="modal" data-bs-target="#modalArchiveRenter">
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#8B0000"><path d="m422-232 207-248H469l29-227-185 267h139l-30 208ZM320-80l40-280H160l360-520h80l-40 320h240L400-80h-80Zm151-390Z"/></svg>
              Electric Bill
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingB5">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqB5">
              <span class="text-start text-wrap w-100">How do I check the current water bill for a renter?</span>
            </button>
          </h2>
          <div id="faqB5" class="accordion-collapse collapse" data-bs-parent="#accordionBilling">
            <div class="accordion-body">
              Go to the <span class="badge bg-danger"><i class="bi bi-receipt"></i> Billing</span> tab, click <button type="button" class="ms-1 btn-red d-inline-flex align-items-center gap-2 px-3 py-1" id="renter-button-modify-renter" data-bs-toggle="modal" data-bs-target="#modalAddRenter">
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#8B0000"><path d="M491-200q12-1 20.5-9.5T520-230q0-14-9-22.5t-23-7.5q-41 3-87-22.5T343-375q-2-11-10.5-18t-19.5-7q-14 0-23 10.5t-6 24.5q17 91 80 130t127 35ZM480-80q-137 0-228.5-94T160-408q0-100 79.5-217.5T480-880q161 137 240.5 254.5T800-408q0 140-91.5 234T480-80Zm0-80q104 0 172-70.5T720-408q0-73-60.5-165T480-774Q361-665 300.5-573T240-408q0 107 68 177.5T480-160Zm0-320Z"/></svg>
              Water Bill
            </button> and check the renter payment details.
          </div>
        </div>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingC1">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqC1">
          ...
          <div id="faqC1" class="accordion-collapse collapse" data-bs-parent="#accordionTask">
            <div class="accordion-body">
              Go to the <span class="badge bg-danger"><i class="bi bi-clipboard-check"></i> Task Management </span> tab, click
              <button type="button" class="ms-1 btn-red d-inline-flex align-items-center gap-2 px-3 py-1" id="task-button-add-task" data-bs-toggle="modal" data-bs-target="#modalAddTask">
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#8E1616"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
              Add Task </button> at the top right, then fill out the form with the task title, type, concerned person and due date. 
          </div>
        </div>
      </div>
        ...
        <div class="accordion-item">
          ...
          <div id="faqC2" class="accordion-collapse collapse" data-bs-parent="#accordionTask">
            <div class="accordion-body">
              Navigate to the <span class="badge bg-danger"><i class="bi bi-clipboard-check"></i> Task Management </span> tab, 
        ...
        <div class="accordion-item">
          ...
          <div id="faqC3" class="accordion-collapse collapse" data-bs-parent="#accordionTask">
            <div class="accordion-body">
              Click the <button type="button" class="ms-1 btn-red-fill d-inline-flex align-items-center gap-2 px-3 py-1" id="button-check" data-bs-toggle="modal" data-bs-target="#modalCompleteTask">
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#e3e3e3"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg>
        ...
        <div class="accordion-item">
          ...
          <div id="faqC4" class="accordion-collapse collapse" data-bs-parent="#accordionTask">
            <div class="accordion-body">
              Tasks past their due date will be labeled with a <span class="badge rounded-pill bg-warning" id="status">Overdue</span>
        ...
        <div class="accordion-item">
          ...
          <div id="faqC5" class="accordion-collapse collapse" data-bs-parent="#accordionTask">
            <div class="accordion-body">
            Go to the <span class="badge bg-danger"><i class="bi bi-clipboard-check"></i> Task Management </span> tab, and click the
            <button type="button" class="ms-1 btn-red-fill d-inline-flex align-items-center gap-2 px-3 py-1">
            <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#FFFFFF"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingD1">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqD1">
          ...
          <div id="faqD1" class="accordion-collapse collapse" data-bs-parent="#accordionRoom">
            <div class="accordion-body">
              Go to the <span class="badge bg-danger"><i class="bi bi-door-closed"></i> Room Information </span> tab, and click
              <button type="button" class="ms-1 btn-red d-inline-flex align-items-center gap-2 px-3 py-1" id="room-button-add-room" data-bs-toggle="modal" data-bs-target="#modalAddRoom">
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#8E1616"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingD2">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqD2">
          ...
          <div id="faqD2" class="accordion-collapse collapse" data-bs-parent="#accordionRoom">
            <div class="accordion-body">
              Navigate to the <span class="badge bg-danger"><i class="bi bi-door-closed"></i> Room Information </span> tab, 
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingD3">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqD3">
          ...
          <div id="faqD3" class="accordion-collapse collapse" data-bs-parent="#accordionRoom">
            <div class="accordion-body">
              Yes, Go to the <span class="badge bg-danger"><i class="bi bi-door-closed"></i> Room Information </span> tab, 
              click the <button type="button" class="ms-1 btn-red-fill d-inline-flex align-items-center gap-2 px-3 py-1" id="button-edit" data-bs-toggle="modal" data-bs-target="#modalModifyRoom">
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#FFFFFF"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingD4">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqD4">
          ...
          <div id="faqD4" class="accordion-collapse collapse" data-bs-parent="#accordionRoom">
              <div class="accordion-body">
              Go to the <span class="badge bg-danger"><i class="bi bi-door-closed"></i> Room Information </span> tab, 
              and click the <button type="button" class="ms-1 btn-red-fill d-inline-flex align-items-center gap-2 px-3 py-1" id="button-delete" data-bs-toggle="modal" data-bs-target="#modalDeleteRoom">
              <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#e3e3e3"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingD5">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqD5">
        ...
        <div id="faqD5" class="accordion-collapse collapse" data-bs-parent="#accordionRoom">
          <div class="accordion-body">
            Go to the <span class="badge bg-danger"><i class="bi bi-door-closed"></i> Room Information </span> tab, and 
            click the <button type="button" class="ms-1 btn-red-fill d-inline-flex align-items-center gap-2 px-3 py-1" id="button-view" data-bs-toggle="modal" data-bs-target="#modalViewRoomDetails">
            <svg xmlns="http://www.w3.org/2000/svg" height="14px" viewBox="0 -960 960 960" width="14px" fill="#FFFFFF"><path d="M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z"/></svg>
